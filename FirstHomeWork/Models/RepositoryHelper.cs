namespace FirstHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static CustomDataViewRepository GetCustomDataViewRepository()
		{
			var repository = new CustomDataViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static CustomDataViewRepository GetCustomDataViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new CustomDataViewRepository();
